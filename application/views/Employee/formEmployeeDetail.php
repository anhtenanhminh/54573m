				...
				<div class="form-inline form-margin-bottom">
					<div class="form-group">
						<label class="label-item">Staff ID</label> <input type="text"
							...
							id="txtStaffID" style="height: 30px;"> <label class="label-item">Staff
							Name</label> <input type="text"
							class="form-control select-size chung input-small"
							id="txtStaffName" style="height: 30px;"> <label
							class="label-item" style="height: 50px;">D.O.B.</label> <input
							type="text" class="input-small form-control select-size chung"
							id="txtDOB" style="height: 30px;">
						...
						<label class="label-item">Office</label> <input type="text"
							class="form-control select-size chung input-small"
							id="txtStaffOffice" style="height: 30px;"> <label
							class="label-item">Branch</label> <input type="text"
							class="form-control select-size chung input-small"
							id="txtStaffBranch" style="height: 30px;"> <label
							class="label-item">Dept</label> <input type="text"
							class="form-control select-size chung input-small"
							id="txtStaffDept" style="height: 30px;">
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-inline form-margin-bottom">
					<div class="form-group">
						<label class="label-item">Last Name</label> <input type="text"
							class="form-control select-size chung input-small"
							id="txtLastName" style="height: 30px;"> <label class="label-item">Middle
							Name</label> <input type="text"
							class="form-control select-size chung input-small"
							id="txtMiddleName" style="height: 30px;"> <label
							class="label-item" style="height: 50px;">First Name</label> <input
							type="text" class="form-control select-size chung input-small"
							id="txtFirstName" style="height: 30px;">
						...
						<label class="label-item">Working stt</label> <input type="text"
							class="form-control select-size chung input-small"
							id="txtWorkStt" style="height: 30px;"> <label class="label-item">Joined</label>
						<input type="text"
							class="form-control select-size chung input-small"
							id="txtJoinedDate" style="height: 30px;"> <label
							class="label-item">Resigned</label> <input type="text"
							class="form-control select-size chung input-small"
							id="txtResignedDate" style="height: 30px;">
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<label class="label-item">Note:</label> <input type="text"
					class="form-control select-size chung input-small" id="txtNote"
					style="height: 215px;">
			</div>
			<div class="col-md-3">
